    ...
    <div>
        <el-col :span="24">
            <div style="height: 520px;width: 100%">
                <el-row>
                    <h1 style="color: #BE0106">管理员</h1>
                    <el-button size="mini" icon="fa fa-plus" title="增加" type="primary" plain @click="add()">添加管理员</el-button>
...
<!--                                <el-button size="mini" icon="fa fa-plus" title="增加" type="primary" plain @click="add(scope.row)"></el-button>-->
                                <el-button size="mini" icon="fa fa-edit fa-lg" title="修改" type="success" plain @click="edit(scope.row)"></el-button>
<!--                                <el-button size="mini" icon="fa fa-trash fa-lg" title="删除" type="danger" plain @click="del(scope.row)"></el-button>-->
                            </template>
                        </el-table-column>
                    </tern-table>
                </el-row>
